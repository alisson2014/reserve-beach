...
import { ScheduleAdminInfo, ScheduleService } from "../../../service/ScheduleService";

const scheduleService = ScheduleService.getInstance();

export default function Schedules() {
    const [schedulesInfo, setSchedulesInfo] = useState<ScheduleAdminInfo[]>([]);
    ...
    const fetchSchedules = useCallback(async () => {
        try {
            setLoading(true);
            const schedules = await scheduleService.getToday(); // 
